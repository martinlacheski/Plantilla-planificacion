...
una figura resumen y una figura correspondiente a cada tarea. Al finalizar, se verá una figura con el diagrama
completo de todas las actividades a ser desarrolladas en el proyecto.

En la figura \ref{fig:ganttGralRes}, se puede visualizar el resumen de cada grupo de tareas asociadas al
desarrollo del proyecto.
...
referidas a la \textbf{tarea 6 - Desarrollo del frontend}.
...
las actividades a ser desarrolladas en el proyecto.
