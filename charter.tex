...
consistirá en {desarrollar un prototipo preliminar de un sistema basado en sensores y actuadores inalámbricos, junto con tecnología en la nube y 
la aplicación web, que permita el monitoreo y control remoto del clima en invernaderos}. 
...
y envía los datos a un servidor en la nube a través del protocolo MQTT (\textit{Message Queue Telemetry Transport}), lo que permitirá a los usuarios monitorear y 
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item La Codirectora \cosupname , experta en Sistemas de Información, ayudará con el seguimiento metodológico, 
		 para garantizar una gestión rigurosa y efectiva del desarrollo del trabajo.
		\end{itemize}
\end{itemize}
...
Diseñar y desarrollar un prototipo preliminar de un sistema basado en sensores y actuadores inalámbricos, junto con tecnología en la nube y la aplicación web, 
que permita el monitoreo y control remoto del clima en invernaderos. El proyecto busca proporcionar a los agricultores un mayor control sobre las condiciones 
ambientales, optimizar el uso de recursos, reducir los costos operativos y contribuir a una mayor sostenibilidad ambiental.
...
\begin{itemize}
	...
	\item Diseño e implementación de la conexión WiFi en el nodo central.
		\begin{itemize}
		\item Configuración de la conectividad WiFi del nodo central para el envío de datos a través de Internet.
		\end{itemize}
	...
	\item Implementación del broker MQTT en el servidor IoT.
		\begin{itemize}
		 \item Configuración del broker MQTT en el servidor para garantizar la comunicación entre el nodo central y el servidor IoT.
		\end{itemize}
	\item Implementación de cifrados de conexión mediante TLS (\textit{Transport Layer Security}).
	    ...
	    \end{itemize}
	\item Envío de información al servidor utilizando MQTT.
		\begin{itemize}
	...
	\item Diseño y desarrollo de una API (\textit{Application Programming Interface}) REST (\textit{Representational State Transfer}).
		\begin{itemize}
		 \item Creación de una API REST que permita la comunicación con el sistema utilizando HTTP, MQTT y WebSockets.
	   	\end{itemize}
	...
	\item Entrega del código del sistema.
		\begin{itemize}
		 \item Desarrollo y entrega del código fuente del sistema, incluyendo todos los componentes desarrollados (sensores, nodo central, servidor, y aplicación web).
	   	\end{itemize}
\end{itemize}
