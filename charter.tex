...
consistirá en {desarrollar un prototipo preliminar de un sistema basado en sensores y actuadores inalámbricos, junto con un servidor en la nube y 
...
La propuesta, como puede observarse en la figura \ref{fig:diagBloques}, consiste en desarrollar una red de sensores y actuadores inalámbricos integrados en
un ESP32-C3, que se conectan a un módulo central mediante tecnología Bluetooth 5.0. Este módulo, también basado en un ESP32-C3, se conecta a Internet vía Wi-Fi 
y envía los datos a un servidor IoT a través del protocolo MQTT (\textit{Message Queue Telemetry Transport}), lo que permitirá a los usuarios monitorear y 
gestionar el sistema de manera remota desde una aplicación web del tipo SPA (\textit{Single Page Application}).
...
\begin{itemize}
	...
	de los requerimientos y el seguimiento del proyecto.
	\item Orientadores: 
	\begin{itemize}
		\item El Director \supname\hspace{1px} es experto en la temática y ayudará con la definición de los protocolos y el desarrollo del proyecto.
...
Diseñar y desarrollar un prototipo preliminar de un sistema basado en sensores y actuadores inalámbricos, junto con un servidor IoT y una aplicación  
web, que permita el monitoreo y control remoto del clima en invernaderos. El proyecto busca proporcionar a los agricultores un mayor control sobre  
las condiciones  ambientales, optimizar el uso de recursos, reducir los costos operativos y contribuir a una mayor sostenibilidad ambiental.

\section{4. Alcance del proyecto}
\label{sec:alcance}

El presemte trabajo incluye:
\begin{itemize}
	\item Implementación del protocolo de comunicación Bluetooth 5.0.
		\begin{itemize}
		\item Desarrollo del protocolo de comunicación para asegurar la conexión entre los sensores y el nodo central mediante Bluetooth 5.0.
		\end{itemize}
	\item Diseño e implementación de la conexión WiFi en el nodo central.
		\begin{itemize}
		\item Configuración de la conectividad WiFi del nodo central para el envío de datos a través de la red.
		\end{itemize}
	\item Desarrollo del software del microcontrolador.
		\begin{itemize}
		 \item Programación del microcontrolador de los sensores y actuadores para la recopilación y transmisión de datos.
		 \item Programación del microcontrolador del nodo central para gestionar la comunicación con los sensores y el servidor IoT.
		\end{itemize}
	\item Implementación del broker MQTT en el servidor IoT.
		\begin{itemize}
		 \item Configuración del broker MQTT para garantizar la comunicación entre el nodo central y el servidor IoT.
		\end{itemize}
	\item Implementación de cifrados de conexión mediante TLS (\textit{Transport Layer Security}).
		\begin{itemize}
		 \item Integración de protocolos de cifrado TLS para asegurar la comunicación entre los sensores, el nodo central y el servidor.
	    \end{itemize}
	\item Envío de información al servidor IoT utilizando MQTT.
		\begin{itemize}
	...
	\item Diseño e implementación de la base de datos.
	   \begin{itemize}
		\item Desarrollo de una base de datos para almacenar los datos recolectados por los sensores y permitir su consulta y análisis.
			\end{itemize}
	\item Diseño y desarrollo de una API (\textit{Application Programming Interface}) REST (\textit{Representational State Transfer}).
		\begin{itemize}
		 \item Creación de una API REST que permita la comunicación con el sistema utilizando HTTP (\textit{Hypertext Transfer Protocol}), MQTT y WebSockets.
	   	\end{itemize}
	\item Desarrollo de una aplicación Web SPA.
		\begin{itemize}
		 \item Integración 
	   	\end{itemize}
	\item Documentación y manuales de usuario.
		\begin{itemize}
		 \item Creación de instrucciones detalladas para el uso del sistema, incluyendo guías de instalación, configuración y operación.
	   	\end{itemize}
	\item Entrega del código del sistema.
		\begin{itemize}
		 \item Desarrollo y entrega del código fuente del sistema, incluyendo todos los componentes desarrollados (sensores, nodo central, servidor 
		 y aplicación web).
	   	\end{itemize}
\end{itemize}

El presemte trabajo no incluye:
\begin{itemize}
	\item Diseño de un gabinete para el microcontrolador y los sensores a utilizar.
	\item Integración con servicios en la nube de terceros.
...
\begin{itemize}
	\item Se contará con los materiales necesarios para la implementación de los nodos de sensores y actuadores, como así también del nodo central.
	\item Se dispondrá del conocimiento necesario para la implementación del protocolo de cifrado TLS y el software necesario en los microcontroladores.
	\item Se dispondrá del conocimiento necesario para el diseño y desarrollo de la base de datos, API y aplicación web.
